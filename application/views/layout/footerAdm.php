            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright Politeknik Caltex Riau 2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <script src="<?=base_url('assets/login')?>/js/demo/chart-area-demo.js"></script>
    <script src="<?=base_url('assets/login')?>/js/demo/chart-pie-demo.js"></script>
    <script>
